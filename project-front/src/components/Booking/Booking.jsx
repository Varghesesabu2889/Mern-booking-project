    ...
    <div className="booking">
      ...
      <div className="booking__form">
        ...
        <Form className='booking__info-form' onSubmit={handleBooking} id='myForm'>
          ...
          <FormGroup>
            <TextField id="tourName" label="Enter your Tour name"  value={title}  variant="standard" onChange={handleChange} type='text' error={errors.tourName} helperText={errors.tourName && "Tour name is required"} className='form-control' required disabled={!user} />
          </FormGroup>
